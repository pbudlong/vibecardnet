...
export function LiveDemoScreen() {
  ...
  return (
    <div className="absolute inset-0 flex bg-[#0a0a0f]">
      <div className="w-[250px] flex-shrink-0 border-r border-border/30 bg-[#0c0c14] flex flex-col overflow-y-auto">
      ...
      <div className="w-[280px] flex-shrink-0 border-l border-border/30 bg-[#0c0c14] overflow-y-auto">
        <TransactionPanel
          splits={demoState.latestSplits}
