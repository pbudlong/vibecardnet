...
export function ViralProjectionScreen() {
  return (
    <div className="h-full w-full flex flex-col items-center justify-start px-6 py-4 overflow-y-auto">
      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-5 gap-4 flex-1">
        ...
        {/* Right column - Viral Mindmap Animation */}
        <motion.div
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.5, delay: 0.2 }}
          className="lg:col-span-3 min-h-[450px] flex items-center justify-center"
        >
